...
urlpatterns = patterns('',
                       ...
                       (r'^fuadmin/image/$','fusite.fu.views.admin_image_index'),
                       (r'^fuadmin/image/(?P<id>\d+)/$','fusite.fu.views.admin_image'),              
                       (r'^fuadmin/issue/(?P<id>\d+)/$','fusite.fu.views.admin_issue'),
                       (r'^fuadmin/issue/(?P<id>\d+)/publish/$','fusite.fu.views.admin_publish_issue'),
                       (r'^fuadmin/issue/(?P<id>\d+)/reorder/$','fusite.fu.views.admin_reorder_issue'),
                       (r'^fuadmin/issue/(?P<id>\d+)/edit_tags/$','fusite.fu.views.admin_edit_issue_tags'),
